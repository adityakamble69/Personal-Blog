...
const pages = [
    {
        ...
        rightContent: {
            ...
            description:
                'Building intelligent systems across Machine Learning, Deep Learning, Computer Vision, NLP, and RAG. My experience includes developing AI-driven solutions, experimenting with LLM-based applications, and working on end-to-end intelligent model pipelines.',
            skills: [
                "Machine Learning",
                "Deep Learning",
                "Computer Vision",
...

    {
        ...
        leftContent: {
            ...
            description:
                'Developing scalable web applications and software systems with a strong focus on clean architecture, backend development, databases, APIs, and modern development workflows. Currently gaining industry experience through a Full Stack Web Development internship at Codomax Digital Solutions.',
            skills: [
...

    {
        ...
        rightContent: {
            ...
            description:
                'Beyond development, I actively contribute to technical communities and collaborative initiatives. My experience as a Techfest IIT Bombay College Ambassador and involvement in academic and technical activities has strengthened my leadership, communication, teamwork, and coordination skills.',
            skills: [
                "Leadership",
                "Teamwork",
                "Communication",
    ...
    {
        isBridge: true,
        heading: 'Explore my experience, projects, and technical journey',
