    ...
    education: [
        {
            label: 'SSC (10th)',
            description:
                'Completed Secondary School Education in 2022 with a strong foundation in Mathematics and Science.',
            orbitIndex: 0,
            position: 0.1,
            imageUrl: '/images/education/ssc.jpg',
        },
        {
            label: 'HSC (12th - Science)',
            description:
                'Completed HSC in 2024 with a focus on Computer Science and developed an interest in programming and web development.',
            orbitIndex: 1,
            position: 0.3,
            imageUrl: '/images/education/hsc.jpg',
        },
        {
            label: 'B.Voc (Software Development)',
            description:
                'Currently pursuing Bachelor of Vocational Education in Software Development from 2024 to 2027.',
            orbitIndex: 0,
            position: 0.55,
            imageUrl: '/images/education/bvoc.jpg',
        },
    ],
    ...
    journey: [
        {
            ...
            description:
                'Building modern, responsive and user-friendly web applications using frontend and backend technologies.',
            orbitIndex: 0,
            position: 0.1,
            imageUrl: '/images/journey/web-development.jpg',
        },
        {
            label: 'Python Projects',
            description:
                'Developing Python-based projects and exploring programming, automation and practical software solutions.',
            orbitIndex: 1,
            position: 0.3,
            imageUrl: '/images/journey/python.jpg',
        },
        {
            label: 'Web Design',
            description:
                'Creating modern and visually appealing websites with a focus on responsive UI and user experience.',
            orbitIndex: 0,
            position: 0.55,
            imageUrl: '/images/journey/web-design.jpg',
        },
        {
            label: 'Personal Projects',
            description:
                'Working on real-world projects including registration systems, PDF automation, forms, e-commerce and portfolio websites.',
            orbitIndex: 1,
            position: 0.75,
            imageUrl: '/images/journey/projects.jpg',
        },
        {
            label: 'Software Development',
            description:
                'Continuously improving skills in full-stack development, data structures and software development.',
            orbitIndex: 0,
            position: 0.92,
            imageUrl: '/images/journey/software-development.jpg',
        },
    ],
    ...
    experience: [
        {
            ...
            description:
                'Currently working as a Web Developer Intern at Asterisc Technocart Pvt Ltd, developing responsive web applications and working with modern web technologies.',
            orbitIndex: 0,
            position: 0.15,
            imageUrl: '/images/experience/asterisc.jpg',
        },
        {
            label: 'Full Stack Web Development Intern',
            description:
                'Codomax Digital Solutions - Internship focused on full-stack web development, hands-on project experience, real-world assignments, and professional software development practices.',
            orbitIndex: 0,
            position: 0.2,
            imageUrl: '/images/experience/codomax.jpg',
        },
        {
            label: 'College Ambassador',
            description:
                'Techfest, IIT Bombay - College Ambassador for Techfest 2026-27, contributing to student engagement, outreach, innovation, and event promotion.',
            orbitIndex: 1,
            position: 0.45,
            imageUrl: '/images/experience/techfest-iitb.jpg',
        },
    ],
};
